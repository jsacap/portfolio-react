...
const PostsList = () => {
  ...
  return (
    <div className='jsa__blog-page'>
      ...
      <p className='col-md-6 text-center'>This page showcases my work as a full-stack developer. Here, you'll find a collection of projects that I've created using different programming languages. To me, a project is more than just code; it's about solving problems and making our lives easier. 
...
Every project is like a puzzle, combining different skills, methods, and technologies that I've learned over time. It's exciting to see these elements come together and create something functional and impactful.</p>
